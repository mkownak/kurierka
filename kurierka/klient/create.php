...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["nadajPaczke"])) {
        ...
        $czyZagraniczna = $_POST['czyZagraniczna'] ? '1' : '0';
        $opis = $_POST['opis'];
...
<body class="createbody">
    ...
    <div class="createformularz">
            ...
            <tr>
                <td>
                    <form action="create.php" method="post" class="createform">
                        ...
                        <label for="czyZagraniczna">Paczka zagraniczna </label>
                        <input type="checkbox" id="czyZagraniczna" name="czyZagraniczna" value="1"><br>

                        <label for="opis">Dodatkowe informacje dla kuriera:</label>
        ...
        <!-- Formularz dla odbiorcy -->
            ...
            <tr>
                <td colspan="2">
                        <input type="submit" name="nadajPaczke" value="Nadaj paczkę" class="createguzik">
                    </form>
                </td>
            </tr>
        </table>
